...
def train_model(train_images_dir, train_labels_dir, model_save_path, val_split=0.2, batch_size=1, num_epochs=10, learning_rate=1e-4, pretrained_model_path=None):
    """
